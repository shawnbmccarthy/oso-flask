"""
simple route just to get user information

All routes in shops.py and carts.py are authorized using the uid found in the uid
request header (note this is not a production app, just a demo)
"""
